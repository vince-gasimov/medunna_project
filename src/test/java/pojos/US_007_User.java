...
public class US_007_User {
    ...
    public US_007_User(String createdBy, String createdDate, int id, String login, String firstName, String lastName, String creaemailtedBy, boolean activated, String langKey, String ssn) {
        this.createdBy = createdBy;
        this.createdDate = createdDate;
        this.id = id;
        this.login = login;
